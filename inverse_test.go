...
func TestInverse(t *testing.T) {
  ...
  assertCloseTo(t, 1.4142, gomath.Inverse(f, 2.0, 1.0, 2.0))
  assertCloseTo(t, 1.7321, gomath.Inverse(f, 3.0, 1.0, 2.0))
  ...
  assertCloseTo(t, 1.4142, gomath.Inverse(f, 2.0, 2.0, 1.0))
  assertCloseTo(t, 1.7321, gomath.Inverse(f, 3.0, 2.0, 1.0))
...
func TestInverseDecreasing(t *testing.T) {
  ...
  assertCloseTo(t, 2.2361, gomath.Inverse(f, 20.0, 1.1, 5.0))
  ...
  assertCloseTo(t, 2.2361, gomath.Inverse(f, 20.0, 5.0, 1.1))
